...
target 'MyApp' do
    pod 'IBMWatsonAssistantV1', '~> 3.3.0'
    pod 'IBMWatsonAssistantV2', '~> 3.3.0'
    pod 'IBMWatsonCompareComplyV1', '~> 3.3.0'
    pod 'IBMWatsonDiscoveryV1', '~> 3.3.0'
    pod 'IBMWatsonLanguageTranslatorV3', '~> 3.3.0'
    pod 'IBMWatsonNaturalLanguageClassifierV1', '~> 3.3.0'
    pod 'IBMWatsonNaturalLanguageUnderstandingV1', '~> 3.3.0'
    pod 'IBMWatsonPersonalityInsightsV3', '~> 3.3.0'
    pod 'IBMWatsonSpeechToTextV1', '~> 3.3.0'
    pod 'IBMWatsonTextToSpeechV1', '~> 3.3.0'
    pod 'IBMWatsonToneAnalyzerV3', '~> 3.3.0'
    pod 'IBMWatsonVisualRecognitionV3', '~> 3.3.0'
end
```
...
```
github "watson-developer-cloud/swift-sdk" ~> 3.3.0
```
...
```swift
dependencies: [
    .package(url: "https://github.com/watson-developer-cloud/swift-sdk", from: "3.3.0")
]
```
...
- Use the access token if you want to manage the lifecycle yourself. For details, see [Authenticating with IAM tokens](https://cloud.ibm.com/docs/watson/getting-started-iam.html). If you want to switch to API key, override your stored IAM credentials with an IAM API key.
