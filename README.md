...
[![Build Status](https://app.travis-ci.com/watson-developer-cloud/swift-sdk.svg?branch=master)](https://app.travis-ci.com/github/watson-developer-cloud/swift-sdk)
...
target 'MyApp' do
    pod 'IBMWatsonAssistantV1', '~> 4.2.1'
    pod 'IBMWatsonAssistantV2', '~> 4.2.1'
    pod 'IBMWatsonCompareComplyV1', '~> 4.2.1'
    pod 'IBMWatsonDiscoveryV1', '~> 4.2.1'
    pod 'IBMWatsonLanguageTranslatorV3', '~> 4.2.1'
    pod 'IBMWatsonNaturalLanguageClassifierV1', '~> 4.2.1'
    pod 'IBMWatsonNaturalLanguageUnderstandingV1', '~> 4.2.1'
    pod 'IBMWatsonPersonalityInsightsV3', '~> 4.2.1'
    pod 'IBMWatsonSpeechToTextV1', '~> 4.2.1'
    pod 'IBMWatsonTextToSpeechV1', '~> 4.2.1'
    pod 'IBMWatsonToneAnalyzerV3', '~> 4.2.1'
    pod 'IBMWatsonVisualRecognitionV3', '~> 4.2.1'
end
```
...
```
github "watson-developer-cloud/swift-sdk" ~> 4.2.1
```
