...
target 'MyApp' do
    pod 'IBMWatsonAssistantV1', '~> 3.4.0'
    pod 'IBMWatsonAssistantV2', '~> 3.4.0'
    pod 'IBMWatsonCompareComplyV1', '~> 3.4.0'
    pod 'IBMWatsonDiscoveryV1', '~> 3.4.0'
    pod 'IBMWatsonLanguageTranslatorV3', '~> 3.4.0'
    pod 'IBMWatsonNaturalLanguageClassifierV1', '~> 3.4.0'
    pod 'IBMWatsonNaturalLanguageUnderstandingV1', '~> 3.4.0'
    pod 'IBMWatsonPersonalityInsightsV3', '~> 3.4.0'
    pod 'IBMWatsonSpeechToTextV1', '~> 3.4.0'
    pod 'IBMWatsonTextToSpeechV1', '~> 3.4.0'
...
```
github "watson-developer-cloud/swift-sdk" ~> 3.4.0
```
