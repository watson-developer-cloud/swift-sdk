...
target 'MyApp' do
    pod 'IBMWatsonAssistantV1', '~> 2.0.3'
    pod 'IBMWatsonAssistantV2', '~> 2.0.3'
    pod 'IBMWatsonCompareComplyV1', '~> 2.0.3'
    pod 'IBMWatsonDiscoveryV1', '~> 2.0.3'
    pod 'IBMWatsonLanguageTranslatorV3', '~> 2.0.3'
    pod 'IBMWatsonNaturalLanguageClassifierV1', '~> 2.0.3'
    pod 'IBMWatsonNaturalLanguageUnderstandingV1', '~> 2.0.3'
    pod 'IBMWatsonPersonalityInsightsV3', '~> 2.0.3'
    pod 'IBMWatsonSpeechToTextV1', '~> 2.0.3'
    pod 'IBMWatsonTextToSpeechV1', '~> 2.0.3'
    pod 'IBMWatsonToneAnalyzerV3', '~> 2.0.3'
