...
openssl aes-256-cbc -K $encrypted_ba57191635e0_key -iv $encrypted_ba57191635e0_iv -in Source/SupportingFiles/WatsonCredentials.swift.enc -out Source/SupportingFiles/WatsonCredentials.swift -d
