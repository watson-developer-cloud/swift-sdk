...
class ConversationTests: XCTestCase {
    ...
    func testMessage() {
        ...
        var context: Context?
        conversation.message(usingWorkspace: workspaceID, failure: failWithError) {
            response in
        ...
        conversation.message(usingWorkspace: workspaceID, text: text, context: context, failure: failWithError) {
            response in
    ...
    func testMessageAllFields1() {
        ...
        conversation.message(usingWorkspace: workspaceID, input: input2, context: context, entities: entities, intents: intents, output: output, failure: failWithError) {
            response in
    ...
    func testMessageAllFields2() {
        ...
        conversation.message(usingWorkspace: workspaceID, text: text2, context: context, failure: failWithError) {
            response in
            context = response.context
            entities = response.entities
            intents = response.intents
        ...
        conversation.message(usingWorkspace: workspaceID, input: input3, context: context, entities: entities, intents: intents, output: output, failure: failWithError) {
            response in
    ...
    func testMessageInvalidWorkspace() {
        ...
        conversation.message(usingWorkspace: workspaceID, failure: failure, success: failWithResult)
        waitForExpectations()
    }
