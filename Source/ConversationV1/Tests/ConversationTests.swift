...
class ConversationTests: XCTestCase {
    ...
    func testMessage() {
        ...
        var context: Context?
        conversation.message(withWorkspaceID: workspaceID, failure: failWithError) {
            response in
        ...
        conversation.message(withWorkspaceID: workspaceID, text: text, context: context, failure: failWithError) {
            response in
    ...
    func testMessageAllFields1() {
        ...
        conversation.message(withWorkspaceID: workspaceID, input: input2, context: context, entities: entities, intents: intents, output: output, failure: failWithError) {
            response in
    ...
    func testMessageAllFields2() {
        ...
        conversation.message(withWorkspaceID: workspaceID, text: text2, context: context, failure: failWithError) {
            response in
            context = response.context
            entities = response.entities
            intents = response.intents
        ...
        conversation.message(withWorkspaceID: workspaceID, input: input3, context: context, entities: entities, intents: intents, output: output, failure: failWithError) {
            response in
    ...
    func testMessageInvalidWorkspace() {
        ...
        conversation.message(withWorkspaceID: workspaceID, failure: failure, success: failWithResult)
        waitForExpectations()
    }
