...
extension Configuration: Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        static let allValues = [configurationID, name, created, updated, description, conversions, enrichments, normalizations]
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        conversions = try container.decodeIfPresent(Conversions.self, forKey: .conversions)
        enrichments = try container.decodeIfPresent([Enrichment].self, forKey: .enrichments)
        normalizations = try container.decodeIfPresent([NormalizationOperation].self, forKey: .normalizations)
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(enrichments, forKey: .enrichments)
        try container.encodeIfPresent(normalizations, forKey: .normalizations)
    }
