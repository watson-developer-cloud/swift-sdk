...
public struct NluEnrichmentEntities {
...
extension NluEnrichmentEntities: Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case model = "model"
        static let allValues = [sentiment, emotion, limit, mentions, mentionTypes, sentenceLocation, model]
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        mentionTypes = try container.decodeIfPresent(Bool.self, forKey: .mentionTypes)
        sentenceLocation = try container.decodeIfPresent(Bool.self, forKey: .sentenceLocation)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(mentionTypes, forKey: .mentionTypes)
        try container.encodeIfPresent(sentenceLocation, forKey: .sentenceLocation)
