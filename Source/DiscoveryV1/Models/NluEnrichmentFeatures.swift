...
public struct NluEnrichmentFeatures {
...
extension NluEnrichmentFeatures: Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        static let allValues = [keywords, entities, sentiment, emotion, categories, semanticRoles, relations]
    }

    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        keywords = try container.decodeIfPresent(NluEnrichmentKeywords.self, forKey: .keywords)
        entities = try container.decodeIfPresent(NluEnrichmentEntities.self, forKey: .entities)
        sentiment = try container.decodeIfPresent(NluEnrichmentSentiment.self, forKey: .sentiment)
        emotion = try container.decodeIfPresent(NluEnrichmentEmotion.self, forKey: .emotion)
        categories = try container.decodeIfPresent(NluEnrichmentCategories.self, forKey: .categories)
        semanticRoles = try container.decodeIfPresent(NluEnrichmentSemanticRoles.self, forKey: .semanticRoles)
        relations = try container.decodeIfPresent(NluEnrichmentRelations.self, forKey: .relations)
    }
