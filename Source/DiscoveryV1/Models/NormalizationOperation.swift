...
public struct NormalizationOperation {
...
extension NormalizationOperation: Codable {

    private enum CodingKeys: String, CodingKey {
        case operation = "operation"
        case sourceField = "source_field"
        case destinationField = "destination_field"
        static let allValues = [operation, sourceField, destinationField]
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        destinationField = try container.decodeIfPresent(String.self, forKey: .destinationField)
    }
