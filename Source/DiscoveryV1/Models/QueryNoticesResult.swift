...
/** QueryNoticesResult. */
public struct QueryNoticesResult {
    ...
    /**
     Initialize a `QueryNoticesResult` with member variables.
     ...
     - returns: An initialized `QueryNoticesResult`.
    */
...
extension QueryNoticesResult: Codable {
