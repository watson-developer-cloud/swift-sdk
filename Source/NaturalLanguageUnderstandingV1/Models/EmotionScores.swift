...
public struct EmotionScores: JSONDecodable,JSONEncodable {
    ...
    /**
     Initialize a `EmotionScores` with required member variables.
    ...
    */
    ...
    /**
    Initialize a `EmotionScores` with all member variables.
    ...
    - returns: An initialized `EmotionScores`.
    */
    public init(anger: Double, disgust: Double, fear: Double, joy: Double, sadness: Double) {
        self.anger = anger
    ...
    // MARK: JSONDecodable
    /// Used internally to initialize a `EmotionScores` model from JSON.
    ...
    // MARK: JSONEncodable
    /// Used internally to serialize a `EmotionScores` model to JSON.
