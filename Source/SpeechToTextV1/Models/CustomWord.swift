...
extension CustomWord: Codable {

    private enum CodingKeys: String, CodingKey {
        case word = "word"
        case soundsLike = "sounds_like"
        case displayAs = "display_as"
        static let allValues = [word, soundsLike, displayAs]
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        displayAs = try container.decodeIfPresent(String.self, forKey: .displayAs)
    }

    public func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encodeIfPresent(word, forKey: .word)
        try container.encodeIfPresent(soundsLike, forKey: .soundsLike)
        try container.encodeIfPresent(displayAs, forKey: .displayAs)
    }
