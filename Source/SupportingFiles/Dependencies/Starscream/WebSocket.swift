...
internal class WebSocket: NSObject, StreamDelegate {
    ...
    */
     ...
     */
    internal func write(string: String, completion: (() -> Void)? = nil) {
    ...
    /**
     ...
     - parameter completion: The (optional) completion handler.
     */
    internal func write(data: Data, completion: (() -> Void)? = nil) {
        guard isConnected else { return }
     ...
     */
    internal func write(ping: Data, completion: (() -> Void)? = nil) {
        guard isConnected else { return }
     ...
     */
    private func dequeueWrite(_ data: Data, code: OpCode, writeCompletion: (() -> Void)? = nil) {
        writeQueue.addOperation { [weak self] in
