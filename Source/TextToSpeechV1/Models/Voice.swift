...
extension TextToSpeechV1 {
    ...
    /**
     *  Voice structure which contains information about the voice specified with the voice path
     *  parameter.
     */
    public struct Voice: JSONDecodable {
        ...
        /// The name of the voice. Use this value as the voice identifier in all requests that accept a voice.
        ...
        /// A Customization object that provides information about a specific custom voice model for the voice. Returned only when a customization_id is is specified with the call.
