...
public struct Classifier {
    ...
    */
    public init(classifierID: String, name: String, owner: String? = nil, status: String? = nil, explanation: String? = nil, created: String? = nil, classes: [ModelClass]? = nil, retrained: String? = nil) {
...
extension Classifier: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        classes = try container.decodeIfPresent([ModelClass].self, forKey: .classes)
