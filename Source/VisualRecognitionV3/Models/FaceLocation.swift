...
public struct FaceLocation {
    ...
    /**
     ...
     - parameter _left: X-position of top-left pixel of face region.
     - parameter top: Y-position of top-left pixel of face region.

     - returns: An initialized `FaceLocation`.
    */
    public init(width: Double, height: Double, _left: Double, top: Double) {
        self.width = width
        self.height = height
        self._left = _left
        self.top = top
...
extension FaceLocation: Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case _left = "left"
        case top = "top"
        static let allValues = [width, height, _left, top]
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        _left = try container.decode(Double.self, forKey: ._left)
