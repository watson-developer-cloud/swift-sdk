...
public struct RuntimeResponseGenericRuntimeResponseTypeIframe: Codable, Equatable {
    ...
    /**
      Initialize a `RuntimeResponseGenericRuntimeResponseTypeIframe` with member variables.
      ...
      - returns: An initialized `RuntimeResponseGenericRuntimeResponseTypeIframe`.
     */
    public init(
        responseType: String,
        source: String,
