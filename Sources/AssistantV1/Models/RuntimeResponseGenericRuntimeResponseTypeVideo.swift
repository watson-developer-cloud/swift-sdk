...
/**
 ...
 Enums with an associated value of RuntimeResponseGenericRuntimeResponseTypeVideo:
    RuntimeResponseGeneric
 */
public struct RuntimeResponseGenericRuntimeResponseTypeVideo: Codable, Equatable {
    ...
    /**
      Initialize a `RuntimeResponseGenericRuntimeResponseTypeVideo` with member variables.
      ...
      - returns: An initialized `RuntimeResponseGenericRuntimeResponseTypeVideo`.
     */
    public init(
        responseType: String,
        source: String,
