...
class VisualRecognitionTests: XCTestCase {
    ...
    func createCollectionWithFaceImages() {
        ...
        visualRecognition.addImageToCollection(withID: collection, imageFile: sign, failure: failure3) { _ in
    ...
    func testDetectFacesByImage1() {
        ...
        visualRecognition.detectFaces(inImageFile: obama, failure: failWithError) { faceImages in
    ...
    func testDetectFacesByImage2() {
        ...
        visualRecognition.detectFaces(inImageFile: faces, failure: failWithError) { faceImages in
